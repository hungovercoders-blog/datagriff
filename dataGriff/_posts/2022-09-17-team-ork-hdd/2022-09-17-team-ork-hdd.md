...
classDiagram
      ...
      Organisation <|-- Team3
      Team1 <|-- Objective1
      Objective1 <|-- Hypothesis1
      Hypothesis1 <|-- WorkItem1
      WorkItem1 <|-- Development1
      Team2 <|-- Objective2
      Objective2 <|-- Hypothesis2
      Hypothesis2 <|-- WorkItem2
      WorkItem2 <|-- Development2
      Team3 <|-- Objective3
      Objective3 <|-- Hypothesis3
      Hypothesis3 <|-- WorkItem3
      WorkItem3 <|-- Development3
      class Organisation{
          Strategy
      }
      class Team1{
