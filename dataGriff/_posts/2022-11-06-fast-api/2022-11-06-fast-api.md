...
Under the GET method you will see the description you added to the docstring. You will also see a "try it out button". Click on this button and then click execute. You will see the beer list in the response showing you can test the API works as expected right here in the browser swagger documents out of the box. Very cool.
...
Below is the complete code that you will need in a file to run. To run the code you just need to run the following in a terminal:
